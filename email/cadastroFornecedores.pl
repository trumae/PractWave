...
To: $toemail
Subject: Use o PractWave para gerenciar fornecedores  
MIME-Version: 1.0
...
Hoje, ainda como parte das novidades do site, vamos tratar de outro tipo de gerenciamento: o dos seus fornecedores. Tão importante quanto manter a organização e a praticidade no controle de clientes, o gerenciamento de fornecedores garante ao usuário do PractWave uma forma de listar contatos, gastos e pagamentos de maneira rápida e acessível.
<br><br>
No Practwave, gerenciar informações de fornecedores é muito fácil e, para provar isso, fizemos um simples passo a passo que você poderá seguir. 
Acesse <a href="http://blog.practwave.com.br/2012/11/gerenciando-fornecedores-no-practwave.html">aqui</a>! 
               <br><br>
