...
To: $toemail
Subject: Extensão para Google Chromium 
MIME-Version: 1.0
    ...
    <title>PractWave.com.br | E-mail</title>
	  ...
	  <body style="padding:0;margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:100%;background-color:#ffffff;" bgcolor="#ffffff">
	     <table width="640" border="0" cellspacing="0" cellpadding="0" class="emailwrapto100pc">
               <tr>
	         <td>
Se você é usuário do Google Chromium, para facilitar e agilizar a sua vida, nossa equipe lançou uma extensão do PractWave para esse navegador. Acesse o 
<a href="http://blog.practwave.com.br/2012/09/para-facilitar-e-agilizar-vida-dos.html">artigo</a> e aprenda como instalar.
               <br><br>
