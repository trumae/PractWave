...
To: $toemail
Subject: PractWave: Gerenciar salão de beleza no Practwave 
MIME-Version: 1.0
    ...
    <title>PractWave.com.br | E-mail</title>
	  ...
	  <body style="padding:0;margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:100%;background-color:#ffffff;" bgcolor="#ffffff">
	     <table width="640" border="0" cellspacing="0" cellpadding="0" class="emailwrapto100pc">
               <tr>
	         <td>
A cada passo a passo mostrado no nosso blog, as diferentes funcionalidades e op&ccedil;&otilde;es do Practwave foram apresentadas e explicadas da forma mais clara e compreens&iacute;vel a voc&ecirc; usu&aacute;rio e integrante dessa nova onda de praticidade.
<br><br>
    N&atilde;o satisfeita, nossa equipe quer facilitar ainda mais a sua experi&ecirc;ncia com o aplicativo. Tendo isso em vista, publicaremos posts com exemplos de uso do Practwave, ou seja, como voc&ecirc; poder&aacute; utiliz&aacute;-lo de acordo com a realidade do seu neg&oacute;cio.
<br><br>
    No exemplo de hoje, vamos demonstrar como uma propriet&aacute;ria (ou propriet&aacute;rio) de um sal&atilde;o de beleza poder&aacute; utilizar as principais fun&ccedil;&atilde;es do software. Continue lendo <a href="http://blog.practwave.com.br/2012/12/gerenciar-salao-de-beleza-no-practwave.html">aqui</a>.
