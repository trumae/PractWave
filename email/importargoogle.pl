...
To: $toemail
Subject: Importe seus contatos do Google como Clientes ou Fornecedores 
MIME-Version: 1.0
    ...
    <title>PractWave.com.br | E-mail</title>
	  ...
	  <body style="padding:0;margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:100%;background-color:#ffffff;" bgcolor="#ffffff">
	     <table width="640" border="0" cellspacing="0" cellpadding="0" class="emailwrapto100pc">
               <tr>
	         <td>
Desejando sempre inovar e facilitar o seu trabalho, n&oacute;s da PractWave, estamos disponibilizando mais uma funcionalidade. Quem utiliza sua conta no Google para entrar no aplicativo, poder&aacute; importar seus contatos dessa conta! Voc&ecirc; pode classific&aacute;-los como clientes ou fornecedores. Muito mais r&aacute;pido e f&aacute;cil do que adicionar um a um! Acesse o <a href="http://blog.practwave.com.br/2012/11/importar-contatos-do-google-no-practwave.html">artigo</a> e aprenda como fazer. 
